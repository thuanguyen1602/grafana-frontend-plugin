...
var SimplePanel = function SimplePanel(_a) {
  var options = _a.options,
      series = _a.data.series,
      width = _a.width,
      height = _a.height;
  var fields = series[0].fields;
  console.log(fields[0].values.get(0));
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Table"], {
    width: width,
    height: height,
    resizable: true,
    data: {
